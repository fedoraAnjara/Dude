    ...
    <div className="space-y-6">
        ...
        <form onSubmit={handleAddMember} className="space-y-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="text-gray-900 flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
              required
            />
            <button
              type="submit"
      ...
      <div>
        ...
        <div className="bg-gray-50 rounded-lg p-3 mb-4">
          <p className="text-gray-500 font-medium">{project.owner.firstName} {project.owner.lastName}</p>
            ...
            <div className="space-y-2 mb-4">
              {project.administrators.map(admin => (
                <div key={admin._id} className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 font-medium">{admin.firstName} {admin.lastName}</p>
            ...
            <div className="space-y-2">
              {project.team.map(member => (
                <div key={member._id} className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 font-medium">{member.firstName} {member.lastName}</p>
